...
In standard MPM, there are two equivalent ways of deriving expression for $\mathbf{f}_i$: from discretizing the weak form of momentum equation or as the negative gradient
